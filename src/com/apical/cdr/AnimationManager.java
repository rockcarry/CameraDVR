...
public class AnimationManager {
    ...
    public static final float FLASH_ALPHA_START = 0.9f;
    public static final float FLASH_ALPHA_END = 0f;
    public static final int FLASH_DURATION = 365;

    public static final int SHRINK_DURATION = 365;
    public static final int HOLD_DURATION = 888;
    public static final int SLIDE_DURATION = 888;
